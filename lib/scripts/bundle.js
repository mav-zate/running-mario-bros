...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mario__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__brick_generator__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__goomba_generator__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__background_generator__ = __webpack_require__(4);
...
window.addEventListener('DOMContentLoaded', __WEBPACK_IMPORTED_MODULE_3__score__["a" /* default */]);
...
const game = () => {
  ...
  window.addEventListener('keydown', keyPress => {
    ...
    if (!PAUSED && (keyPress.key === 'p' || keyPress.key === 'P')) {
      pause();
      PAUSED = !PAUSED;
    } else if (PAUSED && (keyPress.key === 'p' || keyPress.key === 'P')) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__goomba__ = __webpack_require__(8);
...
/* harmony default export */ __webpack_exports__["a"] = (scoreScript);
