...
document.addEventListener('DOMContentLoaded', () => {
  ...
  mario.receiveOthers(bricks + [goomba]);

  window.setInterval(goomba.render, 60);
...
class Goomba {
  ...
  render() {
    ...
    // re-render Goomba
    if (this.state.alive) {
      this.runIdx = (this.runIdx + 1) % this.state.images.length;
      this.context.drawImage(this.state.images[this.runIdx],
