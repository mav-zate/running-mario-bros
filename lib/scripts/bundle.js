...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__goomba_generator__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__goomba__ = __webpack_require__(6);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__goomba__ = __webpack_require__(6);
...
class GoombaGenerator {
  ...
  render() {
    this.context.clearRect(0, CANVAS_HEIGHT - (2 * GOOMBA_HEIGHT),
    CANVAS_WIDTH, (2 * GOOMBA_HEIGHT));
  ...
  generateGoomba() {
    let goomba = new __WEBPACK_IMPORTED_MODULE_0__goomba__["a" /* default */](this.context);
