...
const game = () => {
  ...
  const sprites = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__initialize__["a" /* default */])(context, marioContext, backgroundContext);
  ...
  let backgroundInt = window.setInterval(BackgroundGenerator.render, 17);
